...
HRESULT Mesh::CreateInstanceLayout(ID3D11Device* pd3dDevice, 
	...
	const D3D11_INPUT_ELEMENT_DESC layout[] = // http://msdn.microsoft.com/en-us/library/bb205117%28v=vs.85%29.aspx
	{
        ...
        { "INVPOSITION", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
        { "INVPOSITION", 1, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
        { "INVPOSITION", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 },
        { "INVPOSITION", 3, DXGI_FORMAT_R32G32B32A32_FLOAT, 1, D3D11_APPEND_ALIGNED_ELEMENT, D3D11_INPUT_PER_INSTANCE_DATA, 1 }
	};
...
int Mesh::AddInstance(D3DXMATRIX* m)
{
	...
	D3DXMatrixInverse(&m_MeshInstanceMatrices[instanceID].InvTransformation,NULL, &m_MeshInstanceMatrices[instanceID].Transformation);
	m_InstanceCount++;
	return instanceID;
}
